...
public class DetailsActivity extends Activity implements DetailsView {
	...
	private void initView(){
		mToolbar = (Toolbar) findViewById(R.id.activity_details_toolbar);
		mVwCircle = findViewById(R.id.activity_details_vw_circle);
		mTvTitle = (TextView) findViewById(R.id.activity_details_tv_title);
		mTvForks = (TextView) findViewById(R.id.activity_details_tv_forks);
		mTvStars = (TextView) findViewById(R.id.activity_details_tv_stars);
		mTvWatchers = (TextView) findViewById(R.id.activity_details_tv_watchers);
		mCvLayout = (CardView) findViewById(R.id.activity_details_cv_layout);

		mStars = getString(R.string.stars);
		mFollowers = getString(R.string.followers);
		mForks = getString(R.string.forks);
